    ...
    <div className="home-container">
      ...
      <section className="home-about">
        <div className="home-about-text">
          ...
          <p>
            At <strong>Mindron Foundation</strong>, compassion and curiosity
            come together to unlock human potential. Founded to support learners
            and communities with worthwhile opportunities, paving the way for
            knowledge, technology, and care work hand in hand to change lives.
          </p>
          <p>
          ...
          <p>
            Fundamentally, we think that one strong mind can elevate a whole
            community. When thoughtful technology meets genuine care, learning
            becomes more than just marks and exams—it becomes a bridge to
      ...
      <section className="home-stats">
        ...
        <p>
          Every day, countless individuals struggle to access basic health
          services. With your support, the Mindron Foundation can reach more
